...
class WorkTasksPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    tasks = Provider.of<TasksRepository>(context).workTasks;
              ...
              child: Consumer<TasksRepository>(
                  builder: (_, repository, Widget) {
                    return ListView.builder(
                      itemCount: repository.workTasks.length,
                      itemBuilder: (context, index) {
                        final task = repository.workTasks[index];
                        return Dismissible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        //     children: [
                                        //       Text(DateFormat.MMMMEEEEd().format(task.created_at!),
                                        //         style: TextStyle(
